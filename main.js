...
let fullInfo = function () {
  let info = this.name + ' ' + this.model + ', ' + this.engine + 'cc, year ' + this.year + ', ' + this.used
  return info
}
...
console.log(car2.info()); // Chevrolet Lacetti, 2000cc, year 2010, used
